            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="brand_name" value="{{ $brand->brand_name }}" class="form-control" placeholder="Nhập tên thương hiệu">
                        @error('name')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Mô tả:</strong>
                        <input type="text" name="brand_description" value="{{ $brand->brand_description }}" class="form-control" placeholder="Nhập mô tả">
                        @error('description')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
