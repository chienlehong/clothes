                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$product->product_name}}" name="product_name" class="form-control" placeholder="Tên sản phẩm">
                                @error('product_name')
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="price" value="{{$product->price}}" class="form-control" placeholder="Tên sản phẩm">
                                @error('price')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
